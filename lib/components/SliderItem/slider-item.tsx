...
const SliderItem = ({
                      backgroundUrl, backgroundColor = 'white', children
                    }: React.PropsWithChildren<SliderItemProps>) => {
    ...
    <div className={styles.layout}>
      <div className={styles.cutoff}>
        <svg width="232" height="260" viewBox="0 0 232 260" fill="none" xmlns="http://www.w3.org/2000/svg"
          ...
          <g clipPath="url(#clip0_48_204)">
            <mask id="mask0_48_204" maskUnits="userSpaceOnUse" x="0" y="0" width="232" height="260">
              <path
            ...
            <g mask="url(#mask0_48_204)">
              <rect width="232" height="260" fill="#8CC8FF"/>
              <rect width="232" height="260" fill="url(#pattern0)"/>
            </g>
          </g>
          <defs>
            <pattern id="pattern0" patternContentUnits="objectBoundingBox" width="1" height="1">
              <use xlinkHref="#image0_48_204" transform="matrix(0.00224138 0 0 0.002 -0.0603448 0)"/>
            </pattern>
            <clipPath id="clip0_48_204">
              <rect width="232" height="260" rx="30" fill="white"/>
            </clipPath>
            <image id="image0_48_204" width="500" height="500" xlinkHref={backgroundUrl}/>
          </defs>
        </svg>
      </div>
